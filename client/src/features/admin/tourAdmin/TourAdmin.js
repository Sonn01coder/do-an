...
export default function TourAdmin() {
  ...
  return (
    ...
    {
        !(location.pathname.includes(ROUTER.ADMIN_TOUR_CREATE) || location.pathname.includes(ROUTER.ADMIN_TOUR_DETAIL) ) ? 
        (
          <div className='productManagement_body'>
             <div className='productManagement_body-header'>
                 ...
                 <div className='productManagement_body-header-search'>
                   <Link to={ROUTER.ADMIN_TOUR_CREATE}><button>Create</button></Link>
